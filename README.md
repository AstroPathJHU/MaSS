...
2. Enter the function to be run with the following inputs:
   ...
   - E.g. ```MaSS('*DIR \inform_data','MXX','*DIR \MergeConfig_01.xlsx');```
...
3. Once MaSS.m has finished, run  CreateImageQAQC.m in the same way
   ...
   - E.g. ```CreateImageQAQC('*DIR \inform_data','MXX','*DIR \MergeConfig_01.xlsx');```
### ***Command Line*** ###
...
3. Once MaSS.m has finished, run  CreateImageQAQC.m in the same way
   ...
   - E.g. ```matlab -nodesktop -nojvm -r "CreateImageQAQC('*DIR \inform_data','MXX','*DIR \MergeConfig_01.xlsx')";```
